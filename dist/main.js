...
const result = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(2022, 3, 13), 'dd/MM/yyyy')
console.log(result)
...
function addDataDate(source) {
    ...
    for (let i = 0; i < source.length; i++) {
        ...
        const formatDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(date, 'dd.MM.yyyy')
...
(0,_todos_js__WEBPACK_IMPORTED_MODULE_1__.addToList)("Zupa", "Zamrozić", new Date("2022-08-13"), "high", "notatka", "ważny projekt", false)
;(0,_todos_js__WEBPACK_IMPORTED_MODULE_1__.addToList)("Program", "Napisać", new Date("2022-09-21"), "med", "notatka", "dev project", true)
;(0,_todos_js__WEBPACK_IMPORTED_MODULE_1__.addToList)("Zupa", "Zamrozić", new Date("2022-08-13"), "high", "notatka", "ważny projekt", false)
;(0,_todos_js__WEBPACK_IMPORTED_MODULE_1__.addToList)("Program", "Napisać", new Date("2022-09-21"), "med", "notatka", "dev project", true)
;(0,_todos_js__WEBPACK_IMPORTED_MODULE_1__.addToList)("Zupa", "Zamrozić", new Date("2022-08-13"), "high", "notatka", "ważny projekt", false)
;(0,_todos_js__WEBPACK_IMPORTED_MODULE_1__.addToList)("Program", "Napisać", new Date("2022-09-21"), "med", "notatka", "dev project", true)
;(0,_todos_js__WEBPACK_IMPORTED_MODULE_1__.addToList)("Dziś!", "Napisać", new Date("2022-08-05"), "med", "programowanko", "dev project++", true)
;(0,_todos_js__WEBPACK_IMPORTED_MODULE_1__.addToList)("Jutro!", "Napisać", new Date("2022-08-06"), "med", "programowanko", "dev project++", true)
