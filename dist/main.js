...
function addDataDate() {
    const dom = findDomElements()
    for (let i = 0; i < _todos_js__WEBPACK_IMPORTED_MODULE_0__.todos.length; i++) {
        const date = _todos_js__WEBPACK_IMPORTED_MODULE_0__.todos[i].dueDate
